...
export default function Navbar() {
  ...
  return (
    <>
      <div
        className={` w-full     ${
          Scrolled ? "bg-[#CDD2C0]  " : "bg-transparent"
        }  fixed text-white top-0 left-0 z-50`}
      >
        <p
          className={`rounded-t-2xl  w-full bg-slate-600
py-3 text-center  text-stone-200 block`}
        >
          Free Shipping Above 5000 Pkr.
        </p>
        <div className="navbar  bg-[#CDD2C0]">
          <div className="navbar-start container">
            <div className="dropdown">
              <label
                tabIndex={0}
                className="btn btn-active text-white btn-circle"
              >
                <svg
